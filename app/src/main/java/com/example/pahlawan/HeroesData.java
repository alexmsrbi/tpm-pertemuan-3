...
public class HeroesData {
    ...
    private static int[] heroesImages = {
            ...
            R.drawable.ahmadyani,
            R.drawable.dr_soetomo,
    ...
    public static ArrayList<HeroesModel> getListData(){
        ...
        for (int i = 0; i<heroNames.length;i++){
            ...
            heroesModel.setNamaPahlawan(heroNames[i]);
            heroesModel.setDetailPahlawan(heroDetails[i]);
            heroesModel.setGambarPahlawan(heroesImages[i]);
